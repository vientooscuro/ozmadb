...
export interface IOzmaDBAPI {
  ...
  recursiveDeleteEntity: (
    ref: IEntityRef,
    id: RowKey,
  ) => Promise<IReferencesTree>
  runCommand: (
...
export type TriggerSource =
  | ITriggerInsertSource
  | ITriggerUpdateSource
  | ITriggerDeleteSource
...
export type BeforeInsertTrigger = (
  event: ITriggerEvent,
  args: Record<string, unknown>,
) => Promise<Record<string, unknown> | boolean>
export type BeforeUpdateTrigger = (
  event: ITriggerEvent,
  args: Record<string, unknown>,
) => Promise<Record<string, unknown> | boolean>
export type BeforeDeleteTrigger = (event: ITriggerEvent) => Promise<boolean>
export type AfterInsertTrigger = (
  event: ITriggerEvent,
  args: Record<string, unknown>,
) => Promise<void>
export type AfterUpdateTrigger = (
  event: ITriggerEvent,
  args: Record<string, unknown>,
) => Promise<void>
...
export type UserViewGenerator = (
  layout: ILayout,
) => Promise<Record<UserViewName, string>>
